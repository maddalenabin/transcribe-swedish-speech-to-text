...
def main():
    ...
    # Find a free port
    try:
        port = find_free_port(5001)  # Start from 5001 to avoid macOS AirPlay on 5000
    except RuntimeError:
    ...
    try:
        ...
        if "Address already in use" in str(e):
            ...
            print("1. On macOS: System Preferences → General → AirDrop & Handoff → Turn off 'AirPlay Receiver'")
            print("2. Or run with a specific port: python swedish_transcriber_webapp.py --port 8080")
